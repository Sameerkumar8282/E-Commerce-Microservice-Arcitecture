...
import com.sam.order_service.kafka.OrderProducer;
import com.sam.order_service.mapper.OrderMapper;
import com.sam.order_service.repo.OrderRepository;
...
public class OrderService {
    ...
    public Integer createOrder(OrderRequest request) {
        ...
        //todo check for the customer is exist or not
        var customer = this.customerClient.findCustomerById(request.customerId())
                .orElseThrow(() -> new BusinessException("Cannot create order:: No customer exists with the provided ID"));

        //todo purchase the product
